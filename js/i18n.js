...
(function () {
  const DICT = {
    ...
    en: {
      ...
      nav_guide: "Guide",
      search_ph: "Search musicals, cities, theatres…",
      ...
      runs_from: "From {s}",
      runs_until: "Until {e}",
      long_run: "Long-running",
      date_tbd: "Dates not announced",
      date_until: "Until {e}",
      date_from: "From {s}",
      official: "Official",
      tickets: "Tickets",
      ...
      empty_title: "No matching musicals",
