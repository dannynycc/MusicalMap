...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_lede: '不用註冊就能看。現在全世界有哪些音樂劇在演，百老匯、倫敦西區、各地巡演，都在上面。登入之後，你看過的那些會變成一本自己的音樂劇護照，想給別人看也可以。',
      how_cta_map: '打開地圖', how_cta_me: '做一本自己的護照',
      how_p1_h: '不用註冊就能逛', how_p1_lede: '地圖打開就能用。拖一拖、放大，看看現在哪個城市有戲在演。',
      how_a1_n: '在地圖上', how_a1_h: '地圖上看到的海報就是現在在演的戲', how_a1_p: '標記用的是每齣戲自己的海報。靠得近的會併成一個數字圈，數字是那一帶正在演的場數。點下去就看得到檔期、劇院和售票連結。資料每天自動更新，所以上面是現在真的還在演的。',
      how_a1_p2: '底下那條月份軸可以往後拉，看下個月、下下個月有什麼。按 ▶ 會一個月一個月自己跑，巡演在城市之間移動的樣子就出來了。',
      how_a15_n: '找特定一齣', how_a15_h: '想找某一齣？打劇名就好',
      how_a15_p: '左上角那個搜尋框，劇名、城市、劇院都吃。中文劇名也查得到。同一齣在世界各地的檔期會一起列出來，點哪一場，地圖就飛過去。',
      how_a2_n: '買票', how_a2_h: '每齣戲都附售票連結', how_a2_p: '大部分還會附官方網站。這個站不賣票，只負責把你帶到該去的地方。',
      how_bridge: '',
      how_p2_h: '把看過的記下來', how_p2_lede: '登入之後，你看過的戲會變成一面海報牆、一本蓋章護照、一張足跡地圖，還有一堆統計和一張劇迷戰力圖。這些都是自動生出來的，不用自己整理。',
      how_b0_n: '你的海報牆', how_b0_h: '看過的戲會變成一整面海報牆', how_b0_p: '每加一齣就多一張海報。卡片上有個 ♥，特別喜歡的可以標起來。海報牆、護照、清單是同一批收藏的三種看法，隨時切換。',
      how_b1_n: '加入一齣', how_b1_h: '大部分欄位不用你自己打', how_b1_p: '打劇名就好，中文英文都查得到，劇院、城市、海報會自己填上。剩下的日期、評分、座位、心得看你想寫多少，只記得年份也沒關係。',
      how_b1_p2: '不限現在正在上演的戲。十年前看的、早就下檔的，一樣記得進去，劇院、城市、日期都可以自己改。真的查不到就手動填。',
      how_b15_n: '自訂', how_b15_h: '海報想換成別版的也可以', how_b15_p: '貼一個圖片網址就換掉了，貼完馬上看得到。也可以順便附一條連結，當年的節目頁、售票頁，之後點詳情就找得回來。',
      how_b17_n: '你的足跡地圖', how_b17_h: '釘的是你真的走進去的那家劇院',
      how_b17_p: '看過的戲會長在世界地圖上。位置不是城市中心，是那家劇院。同一個城市看過好幾齣，海報會疊成一疊攤開來。點某個城市，就只看那裡的。',
      how_b2_n: '你的觀劇統計', how_b2_h: '你到底看了多少，這裡算給你看', how_b2_p: '哪幾齣看最多次、去過哪些國家和城市、哪一年哪個月看得最兇，都幫你算好了。',
      how_b18_n: '你是什麼樣的劇迷', how_b18_h: '你是哪一種劇迷？',
      how_b18_p: '劇院常客、嘗鮮作品、劇種涉獵、跨國足跡、狂粉劇迷、音樂劇齡，六個面向各自打分，畫成一張六角圖。旁邊是徽章：第一場、跨過幾個國家、同一齣刷了幾次，達成了就自己亮起來，每一枚後面還有下一級。',
      how_b3_n: '分享出去', how_b3_h: '你的收藏有自己的網址', how_b3_p: '登入時取的名字就是網址。到「分享」把它打開，這一頁就能傳給別人。票價跟座位要不要給人看你自己決定，心得那欄永遠只有你看得到。',
      how_b4_n: '登入很單純', how_b4_h: '跨裝置同步', how_b4_p: '用 Google 一鍵登入，或者留 Email 收一組 6 位數驗證碼，連不到 Google 的地方也進得來。我們只讀你的名稱、Email 和頭像（頭像只有你自己登入後的選單看得到，不會出現在公開頁），不會用你的帳號發任何東西。收藏存在帳號裡，換手機換電腦都還在。',
