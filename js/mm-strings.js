...
(function () {
  var STR = {
    'zh-hant': {
      ...
      del_bye_title: '帳號已刪除', del_bye_body: '你的觀劇紀錄、公開頁與網址名稱都已永久移除。謝謝你曾與 MusicalMap 一起看戲——舞台燈會一直為你留著。',
    ...
    'en': {
      ...
      del_bye_title: 'Your account has been deleted', del_bye_body: 'Your logged shows, public page and username have been permanently removed. Thank you for travelling the musical world with us — the stage lights stay on for you.',
