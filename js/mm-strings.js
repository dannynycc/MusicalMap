...
(function () {
  var STR = {
    'zh-hant': {
      ...
      gate_secure: '用你的 Google 帳戶安全登入。我們只讀取 Google 基本資料（名稱、email 與頭像），不會代你張貼任何內容。',
      ...
      how_b3_n: '分享出去', how_b3_h: '你的個人專屬頁面，一鍵就能分享', how_b3_p: '登入取的名字就是你的專屬網址；到「分享」打開公開開關，這一頁就能傳給朋友。票價、座位要不要公開由你決定；筆記永遠只有你看得到。',
      how_b4_n: '登入很單純', how_b4_h: '用 Google 登入，跨裝置同步', how_b4_p: '我們只讀你的 Google 基本資料（名稱、email 與頭像），不會代你張貼任何內容。你的收藏存在帳號裡，換手機、換電腦都在。',
      ...
      pp_s2_li1: '你的 Google 帳號基本資料——<strong>電子郵件、顯示名稱與頭像</strong>（透過 Google OAuth 取得，用於辨識你的帳號；頭像目前未顯示於本網站）；',
    ...
    'en': {
      ...
      gate_secure: 'Secure sign-in with your Google account. We only read your basic Google profile (name, email and avatar) — we never post anything on your behalf.',
      ...
      how_b4_n: 'Signing in is simple', how_b4_h: 'Sign in with Google, synced everywhere', how_b4_p: 'We only read your basic Google profile (name, email and avatar) — we never post anything on your behalf. Your collection lives in your account, on every phone and laptop.',
      ...
      pp_s2_li1: 'your basic Google profile — <strong>email address, display name and avatar</strong> (obtained via Google OAuth, used to identify your account; the avatar is not currently displayed on this site);',
