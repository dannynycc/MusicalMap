...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_b4_n: '登入很單純', how_b4_h: '跨裝置同步', how_b4_p: '用 Google 一鍵登入，或留下 Email 收一組 6 位數驗證碼——連不到 Google 的地方也進得來。我們只讀你的名稱、email 與頭像（頭像只顯示在你自己登入後的選單，不會出現在公開頁），不會代你張貼任何內容。你的收藏存在帳號裡，換手機、換電腦都在。',
