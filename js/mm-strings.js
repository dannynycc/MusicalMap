...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_b15_n: '自訂', how_b15_h: '海報想換成別版的也可以', how_b15_p: '貼一個圖片網址就換掉了。也能附一條連結，當年的節目頁之後點詳情就找得回來。',
      how_b17_n: '你的足跡地圖', how_b17_h: '釘的是你真的走進去的那家劇院',
      how_b17_p: '不是釘在城市中心。同一個城市看過好幾齣，海報會攤成一疊。點城市只看那裡的。',
      how_b2_n: '你的觀劇統計', how_b2_h: '你到底看了多少，都統計好了', how_b2_p: '哪幾齣看最多次、去過哪些國家和城市、哪一年哪個月看得最兇。',
      how_b18_n: '你是什麼樣的劇迷', how_b18_h: '你是哪一種劇迷？',
      how_b18_p: '六個面向各自打分，畫成一張六角圖。旁邊的徽章達成就會亮，每一枚後面還有下一級。',
      how_b3_n: '分享出去', how_b3_h: '你的海報牆有專屬的網址', how_b3_p: '登入時取的名字就是網址，打開「分享」就能傳給別人。票價跟座位要不要公開你自己決定，心得只有你看得到。',
