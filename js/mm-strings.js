...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_a1_n: '在地圖上', how_a1_h: '每張海報，都是一齣正在上演的劇', how_a1_p: '地圖上的標記就是各音樂劇的海報，相鄰的會聚成一顆數字圓圈——數字是那一帶正在演的場數。點一張海報，看檔期、劇院與售票連結。底部的月份時間軸可以拖到未來或過去的月份，看那個月全球在演什麼；按 ▶ 還會自動逐月播放，看巡演在城市之間移動。',
      ...
      how_b3_n: '分享出去', how_b3_h: '你的個人專屬頁面，一鍵就能分享', how_b3_p: '你的公開頁在登入取名時就準備好了——把網址傳給朋友就行。票價、座位要不要公開由你決定；筆記永遠只有你看得到。',
      ...
      pp_s2_li1: '你的 Google 帳號 <strong>電子郵件與顯示名稱</strong>（透過 Google OAuth 取得，用於辨識你的帳號）；',
    ...
    'en': {
      ...
      how_a1_n: 'On the map', how_a1_h: 'Every poster on the map is a show playing now', how_a1_p: 'Markers are the musicals’ own posters; neighbouring ones gather into a numbered circle — that’s how many are playing around there. Tap a poster for its dates, theatre and ticket links. Drag the month timeline at the bottom to any month, past or future, to see what’s playing then; press ▶ and it plays month by month, tours moving from city to city.',
      ...
      how_b2_n: 'Your theatregoing stats', how_b2_h: 'See enough, and a shape emerges', how_b2_p: 'Most-seen musicals, cities and countries visited, how your theatregoing spreads across years and months — all tallied for you, showing at a glance what kind of theatregoer you are.',
      how_b3_n: 'Share it', how_b3_h: 'Your own personal page, shared in one click', how_b3_p: 'Your public page is ready the moment you sign up — just send friends the link. You decide whether price and seat are shown; your notes stay yours alone.',
      ...
      pp_s2_li1: 'your Google account <strong>email address and display name</strong> (obtained via Google OAuth, used to identify your account);',
