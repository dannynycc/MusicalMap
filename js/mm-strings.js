...
(function () {
  var STR = {
    'zh-hant': {
      ...
      pr_volume_d: '總共進劇院幾次', pr_explorer_d: '看過多少不同作品', pr_genre_d: '涉獵多少不同劇種', pr_global_d: '足跡跨越多少國家與大洲', pr_loyal_d: '同一齣最多刷幾次', pr_age_d: '看戲資歷多少年',
      pr_ev_volume: '{n} 場', pr_ev_explorer: '{n} 部不同作品', pr_ev_genre: '{n} 種劇種', pr_ev_genre0: '尚無劇種標記', pr_ev_global: '{n} 國 · {m} 洲', pr_ev_loyal: '最多 {n} 刷', pr_ev_loyal0: '尚未重看', pr_ev_veteran: '橫跨 {n} 年',
    ...
    'en': {
      ...
      pr_ev_volume: '{n} shows', pr_ev_explorer: '{n} different shows', pr_ev_genre: '{n} genres', pr_ev_genre0: 'no genre tags yet', pr_ev_global: '{n} countries · {m} continents', pr_ev_loyal: 'up to {n}×', pr_ev_loyal0: 'no repeats yet', pr_ev_veteran: '{n}-year span',
