...
(function () {
  var STR = {
    'zh-hant': {
      ...
      pp_s3_p: '登入後，Supabase 會以 cookie / 瀏覽器本機儲存保存你的登入工作階段（session）。本網站本身<strong>不</strong>放置廣告或追蹤用 cookie。',
    ...
    'en': {
      ...
      pp_s3_p: 'After you sign in, Supabase keeps your session in cookies / browser local storage. This site itself places <strong>no</strong> advertising or tracking cookies.',
