...
(function () {
  var STR = {
    'zh-hant': {
      ...
      gate_or: '或', gate_email_lead: '無法使用 Google？用 Email 收驗證碼登入：',
      gate_email_ph: '你的 Email', gate_email_send: '傳送驗證碼', gate_email_sending: '傳送中…',
      gate_email_sent: '驗證碼已寄到 {email}，請查收（垃圾郵件夾也看一下）。',
    ...
    'en': {
      ...
      gate_email_sent: 'Code sent to {email} — check your inbox (and spam folder).',
