...
(function () {
  var STR = {
    'zh-hant': {
      ...
      mi_no_result: '劇庫裡找不到「{v}」', mi_manual_add: '＋ 手動新增（自己打劇名／城市）',
      mi_musical: '音樂劇', mi_manual_input_lbl: '手動輸入（劇庫裡沒有的劇）', mi_manual_title: '手動新增',
      ...
      mi_hint: '試試：打「歌劇魅影」或「phantom」或「les mis」。資料來自 MusicalMap 真實劇庫。',
    ...
    'en': {
      ...
      how_b2_n: 'Your theatregoing stats', how_b2_h: 'See enough, and a shape emerges', how_b2_p: 'Most-seen shows, cities and countries visited, how your theatregoing spreads across years and months — no counting needed, just who you are as a theatregoer.',
