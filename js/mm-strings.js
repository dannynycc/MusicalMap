...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_b1_n: '加入一齣', how_b1_h: '搜音樂劇名，其餘自動帶入', how_b1_p: '中英文搜尋都行，劇院、城市、海報自動補上。填看劇的日期、評分、座位、心得——只記得年份也沒關係。每一齣還能自訂海報圖與連結：貼上你最愛的那版劇照，或當年的節目頁。每看一場，護照上就多一個章。',
    ...
    'en': {
      ...
      how_b1_n: 'Add a musical', how_b1_h: 'Search the title, the rest fills itself in', how_b1_p: 'Search in English or Chinese; theatre, city and poster fill in automatically. Add the date, rating, seat and notes — just the year is fine. Each show can also carry a custom poster and link: paste the artwork you love, or that year’s programme page. Every show you log adds a stamp to your passport.',
