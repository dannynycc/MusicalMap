...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_lede: '不用註冊就能看。百老匯、倫敦西區、各地巡演，現在有哪些音樂劇在演都在上面。登入之後，你看過的那些會變成一本自己的音樂劇護照，歡迎分享給其他人看。',
      how_cta_map: '打開地圖', how_cta_me: '做一本自己的護照',
      how_p1_h: '不用註冊就能逛', how_p1_lede: '拖一拖、放大，看看現在哪個城市有戲。',
      how_a1_n: '在地圖上', how_a1_h: '地圖上看到的海報就是現在在演的戲', how_a1_p: '靠得近的海報會併成一個數字圈。點下去有檔期、劇院和售票連結。資料每天自動更新。',
      how_a1_p2: '底下那條月份軸往後拉，就是下個月、下下個月的戲。按 ▶ 會自己一個月一個月跑。',
      how_a15_n: '找特定一齣', how_a15_h: '想找某一齣？打劇名就好',
      how_a15_p: '劇名、城市、劇院都能搜，中文也可以。同一齣在各地的檔期會一起列出來。',
      how_a2_n: '買票', how_a2_h: '每齣戲都附售票連結', how_a2_p: '超過一半還附了官方網站。連結直接連到售票平台，票在那邊買。',
      how_bridge: '',
      how_p2_h: '把看過的記下來', how_p2_lede: '海報牆、蓋章護照、足跡地圖、觀劇統計、劇迷戰力圖，都會自己長出來。',
      how_b0_n: '你的海報牆', how_b0_h: '看過的戲會變成一整面海報牆', how_b0_p: '每加一齣就多一張海報。喜歡的按 ♥。海報牆、護照、清單三種看法隨時切。',
      how_b1_n: '加入一齣', how_b1_h: '大部分欄位不用你自己打', how_b1_p: '打劇名，劇院、城市、海報就自己填上。日期、評分、座位、心得看你想寫多少，只記得年份也行。',
      how_b1_p2: '十年前看的、早就下檔的一樣記得進去。查不到就手動填。',
      how_b15_n: '自訂', how_b15_h: '海報想換成別版的也可以', how_b15_p: '不喜歡預設那張，貼上圖片網址就能換成你要的。也能存一條連結，當年的節目頁或售票頁，之後從詳情點得開。',
      how_b17_n: '你的足跡地圖', how_b17_h: '釘的是你真的走進去的那家劇院',
      how_b17_p: '地圖上的位置是那家劇院，不是整座城市。同一個城市看過好幾齣，海報會疊在一起攤開來。點某座城市，就只顯示在那裡看的。',
      how_b2_n: '你的觀劇統計', how_b2_h: '看了多少、去了哪些地方，都統計好了', how_b2_p: '哪幾齣看最多次、去過哪些國家和城市、哪一年哪個月看得最多。',
      how_b18_n: '你是什麼樣的劇迷', how_b18_h: '你是哪一種劇迷？',
      how_b18_p: '六個面向各自打分，畫成一張六角圖。旁邊的徽章達成就會亮，每一枚後面還有下一級。',
      how_b3_n: '分享出去', how_b3_h: '你的海報牆有專屬的網址', how_b3_p: '登入時取的名字就是網址。頁首那個開關切到「公開中」，按旁邊的「複製」就能傳給別人。票價跟座位要不要公開你自己決定，心得只有你看得到。',
      how_b4_n: '登入很單純', how_b4_h: '跨裝置同步', how_b4_p: 'Google 或 Email 驗證碼都能登入。我們只讀你的名稱、Email 和頭像，不會用你的帳號發任何東西。收藏存在帳號裡，換手機換電腦都還在。',
      how_final_h: '從哪裡開始都可以', how_final_p: '先去地圖上晃晃，或直接記下你看過的第一齣。', how_final_cta: '做一本自己的護照', how_final_cta2: '先去看地圖',
      how_footer: 'MusicalMap — 全球音樂劇即時地圖，與你的音樂劇護照。', how_footer_link: '回到地圖',
      how_final_about: '這個站是一個音樂劇迷自己做的，故事在這裡 →',
      // ---- about.html(關於頁) ----
  ...
  var HANS_OVERRIDE = {
    ...
    how_lede: '不用注册就能看。百老汇、伦敦西区、各地巡演，现在有哪些音乐剧在上演都在上面。登录之后，你看过的那些会变成一本自己的音乐剧护照，也欢迎分享给别人看。',
    how_cta_map: '打开地图',
    how_cta_me: '做一本自己的护照',
    how_p1_h: '不用注册就能逛',
    ...
    how_a2_n: '买票',
    how_a2_h: '每部剧都带购票链接',
    how_a2_p: '超过一半还附了官方网站。这里不卖票，链接直接跳到售票平台。',
    how_p2_h: '把看过的记下来',
    how_p2_lede: '海报墙、盖章护照、足迹地图、观演统计、剧迷战力图，都会自动生成。',
    how_b0_n: '你的海报墙',
    how_b0_h: '看过的剧会变成一整面海报墙',
    how_b0_p: '每加一部就多一张海报。喜欢的点 ♥ 标出来。海报墙、护照、清单是同一批收藏的三种视图，随时切换。',
    how_b1_n: '加入一部',
    ...
    how_b15_p: '不喜欢默认那张，贴上图片链接就能换成你想要的。也可以存一条链接，当年的节目页或购票页，之后从详情里点开。',
    how_b17_n: '你的足迹地图',
    how_b17_h: '钉的是你真正走进去的那家剧院',
    how_b17_p: '地图上的位置是那家剧院，不是整座城市。同一座城市看过好几部，海报会叠在一起摊开。点某座城市，就只显示在那里看的。',
    how_b2_n: '你的观演统计',
    how_b2_h: '看了多少、去了哪些地方，都统计好了',
    how_b2_p: '哪几部看得最多、去过哪些国家和城市、哪一年哪个月看得最频繁。',
    how_b18_n: '你是哪一类剧迷',
    how_b18_h: '你是哪一类剧迷？',
    how_b18_p: '六个维度各自打分，画成一张六边形图。旁边的徽章达成就会亮起来，每一枚后面还有下一级。',
    how_b3_n: '分享出去',
    how_b3_h: '你的海报墙有专属网址',
    ...
    how_final_about: '这个站是一个音乐剧迷自己做的，背后的故事在这儿 →',
