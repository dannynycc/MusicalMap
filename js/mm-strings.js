...
(function () {
  var STR = {
    'zh-hant': {
      ...
      pp_s6_h: '6. 你的權利',
      pp_s6_p: '你可隨時於「我的音樂劇」中<strong>編輯或刪除</strong>你的紀錄，或於 Google 帳號設定中撤銷對本網站的授權。若希望我們刪除你的帳號與所有相關資料，請來信 <a href="mailto:dannynycc@gmail.com">dannynycc@gmail.com</a>。',
      pp_s7_h: '7. 兒童',
      ...
      tou_intro: '歡迎使用 MusicalMap（「本網站」）。使用本網站即表示你同意以下條款。聯絡方式：<a href="mailto:dannynycc@gmail.com">dannynycc@gmail.com</a>。',
      tou_s1_h: '1. 服務說明',
    ...
    'en': {
      ...
      pp_s6_p: 'You can <strong>edit or delete</strong> your records in My Musicals at any time, or revoke this site’s access in your Google account settings. To have your account and all related data deleted, email <a href="mailto:dannynycc@gmail.com">dannynycc@gmail.com</a>.',
      pp_s7_h: '7. Children',
      ...
      tou_intro: 'Welcome to MusicalMap ("this site"). By using this site you agree to these terms. Contact: <a href="mailto:dannynycc@gmail.com">dannynycc@gmail.com</a>.',
