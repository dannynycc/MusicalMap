...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_a2_n: '買票', how_a2_h: '每齣戲都附售票連結', how_a2_p: '大部分還有官方網站。這個站不賣票。',
      how_bridge: '',
      ...
      how_b2_n: '你的觀劇統計', how_b2_h: '你到底看了多少，這裡算給你看', how_b2_p: '哪幾齣看最多次、去過哪些國家和城市、哪一年哪個月看得最兇。',
      how_b18_n: '你是什麼樣的劇迷', how_b18_h: '你是哪一種劇迷？',
      how_b18_p: '六個面向各自打分，畫成一張六角圖。旁邊的徽章達成就會亮，每一枚後面還有下一級。',
      how_b3_n: '分享出去', how_b3_h: '你的收藏有自己的網址', how_b3_p: '登入時取的名字就是網址，打開「分享」就能傳給別人。票價跟座位要不要公開你自己決定，心得只有你看得到。',
