...
(function () {
  var STR = {
    'zh-hant': {
      ...
      bd_first: '首演 {y}', bd_shows: '觀劇里程 {n}+ 場', bd_countries: '{n}+ 國足跡',
      ...
      bd_traditions: '涉獵 {n} 種劇種', bd_regular: '同一劇院 {n} 場', bd_marathon: '單月看 {n} 場',
    ...
    'en': {
      ...
      bd_first: 'First show {y}', bd_shows: '{n}+ shows milestone', bd_countries: '{n}+ countries',
