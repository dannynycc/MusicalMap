...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_a15_n: '找特定一齣', how_a15_h: '打劇名、城市或劇院，地圖就飛過去',
      how_a15_p: '左上角的搜尋框吃三種東西：音樂劇名、城市、劇院。中文劇名也搜得到；同一齣在世界各地的檔期會一次列出來，點哪一場，地圖就帶你過去。',
      how_a2_n: '一鍵訂票', how_a2_h: '看到喜歡的，直接過去訂', how_a2_p: '每一齣都附售票連結，多數還有官方網站。我們不賣票——只把你帶到對的地方。',
      how_bridge: '看過的那些，別讓它們只留在記憶裡。',
      how_p2_h: '記下你看過的每一齣', how_p2_lede: '登入之後，你看過的劇會長成一面海報牆、一本蓋章護照、一張足跡地圖，還有你的觀劇統計與劇迷戰力圖。全部自動生成。',
      ...
      how_b1_p2: '不限現在正在上演的劇——十年前看的、早就下檔的，一樣記得進去；劇院、城市、日期都可以自己改。真的查不到，手動填也行。',
      how_b15_n: '獨家', how_b15_h: '海報與連結，都能換成你的', how_b15_p: '每一齣都能貼上自訂海報網址——用你記得的那一版劇照，即時預覽。再附一條連結，把當年的節目頁或售票頁存進詳情，隨時點開。',
      how_b17_n: '你的足跡地圖', how_b17_h: '每一齣，都釘在你真正走進去的那家劇院',
      how_b17_p: '看過的劇會在世界地圖上長出來——釘的不是城市中心，是你當晚實際走進去的那家劇院。同一座城市看過好幾齣，海報就攤成一疊扇形。點一座城市，只看那裡的收藏。',
      how_b2_n: '你的觀劇統計', how_b2_h: '看久了，會浮現一個輪廓', how_b2_p: '最常看的音樂劇、去過的城市與國家、各年各月的觀劇分布——都幫你統計好了，一眼看出你是什麼樣的劇迷。',
      how_b18_n: '你是什麼樣的劇迷', how_b18_h: '六個面向，一張圖說完',
      how_b18_p: '劇院常客、嘗鮮作品、劇種涉獵、跨國足跡、狂粉劇迷、音樂劇齡——六個面向各自打分，畫成一張六角圖。旁邊是成就徽章：從第一場、跨過幾個國家，到同一齣刷了幾次，達成就自動亮起來，而且每一枚都還有下一級可以追。',
      how_b3_n: '分享出去', how_b3_h: '你的個人專屬頁面，一鍵就能分享', how_b3_p: '登入取的名字就是你的專屬網址；到「分享」設定公開，這一頁就能傳給朋友。票價、座位要不要公開由你決定；筆記永遠只有你看得到。',
      how_b4_n: '登入很單純', how_b4_h: 'Google 或 Email 都能登入，跨裝置同步', how_b4_p: '用 Google 一鍵登入，或留下 Email 收一組 6 位數驗證碼——連不到 Google 的地方也進得來。我們只讀你的名稱、email 與頭像（頭像只顯示在你自己登入後的選單，不會出現在公開頁），不會代你張貼任何內容。你的收藏存在帳號裡，換手機、換電腦都在。',
    ...
    'en': {
      ...
      how_b4_n: 'Signing in is simple', how_b4_h: 'Google or email — synced everywhere', how_b4_p: 'One tap with Google, or leave your email and we send a 6-digit code — so you can get in from places Google can’t reach. We only read your name, email and avatar (the avatar appears only in your own signed-in menu, never on public pages) — we never post anything on your behalf. Your collection lives in your account, on every phone and laptop.',
