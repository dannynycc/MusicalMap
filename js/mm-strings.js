...
(function () {
  var STR = {
    'zh-hant': {
      ...
      how_lede: '不用註冊就能看。百老匯、倫敦西區、各地巡演，現在在演的都在上面。登入之後，你看過的那些會變成一本自己的音樂劇護照，歡迎分享給其他人看。',
      ...
      how_a2_n: '買票', how_a2_h: '每齣戲都附售票連結', how_a2_p: '超過一半還附了官方網站。點了直接跳到售票平台，票在那邊買。',
      how_bridge: '',
      how_p2_h: '把看過的記下來', how_p2_lede: '海報牆、蓋章護照、足跡地圖、觀劇統計、劇迷戰力圖，都會自己長出來。',
      how_b0_n: '你的海報牆', how_b0_h: '看過的戲會變成一整面海報牆', how_b0_p: '每加一齣就多一張海報。喜歡的按 ♥。海報牆、護照、清單三種看法，隨時可以換。',
      ...
      how_b15_n: '自訂', how_b15_h: '海報想換成別版的也可以', how_b15_p: '不喜歡預設那張，貼上圖片網址就能換成你要的。也能存一條連結，當年的節目頁或售票頁，以後從詳情點開就找得到。',
      how_b17_n: '你的足跡地圖', how_b17_h: '不是標在城市，是標在你去的那家劇院',
      how_b17_p: '同一個城市看過好幾齣，那疊海報會像撲克牌一樣攤開來。點一下城市名，就只留那裡看過的。',
      how_b2_n: '你的觀劇統計', how_b2_h: '看了多少、去了哪些地方，都統計好了', how_b2_p: '哪幾齣看最多次、去過哪些國家和城市、哪一年哪個月看得最多。',
      how_b18_n: '你是什麼樣的劇迷', how_b18_h: '你是哪一種劇迷？',
      how_b18_p: '六個面向各自打分，畫成一張六角圖。旁邊的徽章達成了就會亮起來，每一枚後面還有下一級。',
  ...
  var HANS_OVERRIDE = {
    ...
    how_lede: '不用注册就能看。百老汇、伦敦西区、各地巡演，现在在演的都在上面。登录之后，你看过的那些会变成一本自己的音乐剧护照，也欢迎分享给别人看。',
    how_cta_map: '打开地图',
    how_cta_me: '做一本自己的护照',
    how_p1_h: '不用注册就能逛',
