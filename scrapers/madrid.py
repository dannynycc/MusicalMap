    ...
    for n in range(1, 7):
        ...
        for it in items:
            ...
            shows[sid] = {
                ...
                "tour_name": title_es,  # Spanish production name — kept so the popup shows it even after build_shows canonicalises `title` for grouping (e.g. "Asesinato para dos" stays although group=murder for two)
