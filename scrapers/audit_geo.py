...
BBOX = {
    ...
    # 2026-08-12 補齊:這 9 國原本落在「no bbox」名單裡,等於**從來沒被驗證過**——
    # 稽核每天印「(no bbox for: Argentina, Brazil, …)」卻沒人補,座標錯了也不會被抓到。
    # 這些市場多半靠人工策展(manual.json)或反爬來源,更需要守門。
    "Argentina": (-55.1, -21.8, -73.6, -53.6),
    "Brazil": (-33.8, 5.3, -74.0, -34.8),
    "Hungary": (45.7, 48.6, 16.1, 22.9),
    "Philippines": (4.6, 21.1, 116.9, 126.6),
    "Poland": (49.0, 54.9, 14.1, 24.2),
    "Portugal": (32.4, 42.2, -31.3, -6.2),      # incl. Azores/Madeira
    "South Africa": (-34.9, -22.1, 16.4, 32.9),
    "Turkey": (35.8, 42.2, 25.6, 44.9),
    "United Arab Emirates": (22.6, 26.1, 51.5, 56.4),   # UAE 的另一種國名寫法
}
