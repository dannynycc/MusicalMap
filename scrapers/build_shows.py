...
NOT_MUSICAL_RE = re.compile(
    ...
    r"\bimprovised\b|"   # 2026-08-27 即興音樂劇(Shamilton!/Showstopper!)無固定劇情,無法寫簡介。已驗證只命中即興秀
...
def main():
    ...
    # 必須放在 TM merge 之後——TM/tm_tours 筆不在 SOURCE_FILES,早跑會漏掉純 TM 演出
    # (Évangéline 案,2026-07-14 使用者抓到)。
