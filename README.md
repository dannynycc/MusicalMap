...
淺色地圖鋪滿畫面、海報縮圖當 marker + cluster、hover 預覽卡、點擊跳 popup、側欄一劇一列（同劇自動合併、可展開看各地點）+ 搜尋 + 篩選 + **時間軸**（日期滑桿＋日曆同步，拖到哪天看那天上演什麼；▶ 播放可看巡演在城市間移動）。
...
- ✅ Broadway（28）、West End（52）、北美巡演（broadway.org，297 站）、國際製作（13）、Ticketmaster 全球補洞（125，澳/紐/愛/加/北歐等）：共 515 筆，約 20 國，全部含座標與海報。
