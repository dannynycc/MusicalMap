...
> **近期(v2.6.0)**:me.html 加**帳號中心**——頁面頂部身分卡(monogram+公開/私密 pill+專屬網址+複製;＋加入音樂劇/帳號設定/登出三鈕),帳號設定擴成統一面板(帳號身分改名+公開分享開關+刪除帳號一處管理),舊分享 modal 只留首次登入 onboarding;nav 分享/登出鈕移除。
